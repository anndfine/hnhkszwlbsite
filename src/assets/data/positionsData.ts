...
export const positionsData: Position[] = [
  {
    ...
    title: "主控",
    subtitle: "一场活动的顶梁柱",
    description: "主控要协调整场活动的进程与各个岗位间的行动，可能面对各类突发事件，需要由主控妥善处置，避免失控的出现。",
    icon: "bi-cpu",
    requirements: [
      "沉着冷静，有耐心做完全部流程",
  ...
  },
  {
    ...
    description: "灯控掌握着舞台的整体视觉效果，你的一切操作都直接关系到观众的视觉效果镜头拍摄效果，现场没有特效做，全靠灯光两只手。",
    icon: "bi-lightbulb",
    requirements: [
  ...
  },
  {
    ...
    title: "机动协调",
    subtitle: "后台与前台的连线者",
    description: "机动协调负责外场的特情处置，临时需求的第一线，在后台需要帮助时提供第一时间的援助，功不可没。",
    icon: "bi-people",
    requirements: [
      "良好的特情处置能力",
      "良好的团队配合能力",
